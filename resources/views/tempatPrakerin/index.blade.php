        ...
        <div class="modal-content">
          ...
          <div class="modal-body row px-4">
            <div class="col-md-6 col-12">
              ...
              <div class="preview-map" style=" width: 100%; border-radius: 20px" id="mapEdit-{{ $data->id }}"></div>
            </div>
            <div class="col-md-6 col-12">
              <form id="formEdit" action="{{ route('tempatPrakerin.update', $data->id) }}" method="POST"
                ...
                <div class="row justify-content-center align-items-center">
                  ...
                  <div class="mb-3">
                    ...
                    <input id="description-edit" class="form-control" type="text" value="{{ $data->description }}"
                      name="description" placeholder="Deskripsi Perusahaan">
                    <div id="description-error-edit"></div>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Alamat Perusahaan</label>
                    <input id="address-edit" class="form-control" type="text" value="{{ $data->address }}"
                      name="address" placeholder="Alamat Perusahaan">
                  ...
                  <div class="mb-3">
                    ...
                    <div>
                      @if ($data->image)
                        <div class="mb-3">
                          <img src="{{ asset('storage/' . $data->image) }}" alt="Gambar Lama" class="img-fluid"
                            style="max-width: 200px;">
                        </div>
                      @endif
                    </div>
                    <div>
                      <input id="image-edit" class="form-control" type="file" name="image" id="logo_perusahaan">
                      <div id="image-error-edit"></div>
                    </div>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Latitude</label>
                    <input class="form-control" type="text"value="{{ $data->latitude }}" name="latitude"
                      id="latitudeEdit-{{ $data->id }}" placeholder="Latitude">
                    <div id="latitude-error-edit"></div>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Longitude</label>
                    <input class="form-control" type="text" value="{{ $data->longitude }}" name="longitude"
                      id="longitudeEdit-{{ $data->id }}" placeholder="Longitude">
                    <div id="longitude-error-edit"></div>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="submit" class="btn btn-primary" id="submitButtonEdit">Simpan</button>
                  </div>
                </div>
              </form>
            </div>
                ...
                <div class="col-12 col-md-6 w-100" style="margin-top: 30px">
                  ...
                  <div class="mb-3">
                    ...
                    <input id="longitude" class="form-control @error('longitude') is-invalid @enderror" type="text"
                      value="{{ old('longitude') }}" name="longitude" id="longitude" placeholder="Longtitude">
    ...
    $(document).ready(function() {
      @foreach ($prakerin as $data)
        $('#modalEdit{{ $data->id }}').on('shown.bs.modal', function() {
          initializeMapEdit('{{ $data->id }}', '{{ $data->latitude }}', '{{ $data->longitude }}');
        });
      @endforeach
